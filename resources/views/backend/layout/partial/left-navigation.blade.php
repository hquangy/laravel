...
{{--     <form action="#" method="get" class="sidebar-form">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      <li class="treeview @if(Request::segment(2) == 'blog') {{ 'active' }}  @endif">
        <a href="#">
          <i class="fa fa-dashboard"></i> <span>Quản lý ưu đãi</span>
      ...
      <li class="treeview @if(Request::segment(2) == 'page') {{ 'active' }}  @endif">
        <a href="#">
          <i class="fa fa-files-o"></i> <span>Quản lý Page</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview @if(Request::segment(2) == 'category') {{ 'active' }}  @endif">
        <a href="#">
          <i class="fa fa-files-o"></i> <span>Quản lý Category</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview @if(Request::segment(2) == 'store') {{ 'active' }}  @endif">
        <a href="#">
          <i class="fa fa-files-o"></i> <span>Quản lý cửa hàng</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
