  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          BE
          <small>{{ isset($title) ? $title : 'Control Panel' }}</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="{{ route('be.dashboard.index') }}"><i class="fa fa-dashboard"></i> BE</a></li>
          <li class="active">{{ isset($title) ? $title : 'Home' }}</li>
        </ol>
      </section>

      <!-- Main content -->
      <section class="content">
        @include('backend.layout.partial.admin-errors')
        @include('backend.layout.partial.admin-success')
        @yield('content')
      </section>
      <!-- /.content -->
    </div>
