	...
	<div class="row">
		<div class="col-sm-12">
			<div class="box box-primary">
				...
				<form role="form" action="{{ route('backend.category.update',['id'=> $data['id']]) }}" method="post" enctype="multipart/form-data">
					<div class="box-body">
						@include('backend.category._form',['mode'=>'edit'])
						{{ csrf_field() }}
					</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
			<form method="POST" action="{{ route('backend.category.delete',['id'=>$data['id']])}}">
				{{ csrf_field() }}
