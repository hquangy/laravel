	...
	<div class="row">
		<div class="col-sm-12">
			<div class="box box-primary">
				...
				<form role="form" action="{{ route('backend.blog.update',['id'=> $data['id']]) }}" method="post" enctype="multipart/form-data">
					<div class="box-body">
						@include('backend.blog._form',['mode'=>'edit'])
						{{ csrf_field() }}
					</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
			<form method="POST" action="{{ route('backend.blog.delete',['id'=>$data['id']])}}">
				{{ csrf_field() }}
